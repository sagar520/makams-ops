-- ============================================================
-- Makams Ops — UPGRADE: admins can revoke and delete staff accounts
...
select 'User management installed — revoke, restore and delete are available to admins' as result;
