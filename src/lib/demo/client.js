...
const insertDefaults = {
  ...
  prospectives: () => ({
    id: genId('pr'), cv_no: nextCvNo(), division: null, department: 'Sales', source: 'Other', status: 'new',
    candidate_id: null, resume_path: null, resume_name: null,
    contact2: null, email: null, reference: null, test_score: null,
    stage_mail: null, stage_manager: null, stage_hr: null, stage_final: null, comment: null,
    last_salary: null, expected_inhand: null, old_inhand: null,
    inhand_monthly: null, gross_monthly: null, ctc_annual: null, doj: null, emp_code: null,
    created_by: 'u-aakash', created_at: nowIso(), updated_at: nowIso(),
  }),
