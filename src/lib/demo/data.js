...
export function buildSeedStore() {
  ...
  const people = [
    sales({ id: 'p-01', emp_code: 'RM001', full_name: 'Deepak Verma', status: 'active', sales_role: 'rsm', hq_name: 'Ludhiana', asm_name: null, rsm_name: null, employment_type: 'full_time', date_of_join: '2023-04-10', personal_email: 'deepak.v@gmail.com', phone: '98110 22331', monthly_gross: 65000, learnapp_user_id: 'lu-01', learnapp_email: 'rm001@example.com', learnapp_status: 'active', created_at: iso(88) }),
    sales({ id: 'p-02', emp_code: 'ASM001', full_name: 'Sunita Kaur', status: 'active', sales_role: 'asm', hq_name: 'Ludhiana', asm_name: null, rsm_name: 'Deepak Verma', employment_type: 'full_time', date_of_join: '2023-08-01', personal_email: 'sunita.k@gmail.com', phone: '98220 11445', monthly_gross: 48000, learnapp_user_id: 'lu-02', learnapp_email: 'asm001@example.com', learnapp_status: 'active', created_at: iso(88) }),
    sales({ id: 'p-03', emp_code: 'ASM002', full_name: 'Manpreet Singh', status: 'active', sales_role: 'asm', hq_name: 'Jalandhar', asm_name: null, rsm_name: 'Deepak Verma', employment_type: 'full_time', date_of_join: '2024-01-15', phone: '97790 55662', monthly_gross: 45000, learnapp_user_id: 'lu-03', learnapp_status: 'active', created_at: iso(80) }),
    sales({ id: 'p-04', emp_code: 'SALES001', full_name: 'Arvind Kumar', status: 'active', sales_role: 'sales', hq_name: 'Ludhiana', asm_name: 'Sunita Kaur', rsm_name: 'Deepak Verma', employment_type: 'full_time', date_of_join: '2024-09-20', phone: '96540 33217', monthly_gross: 26000, learnapp_user_id: 'lu-05', learnapp_email: 'sales001@example.com', learnapp_status: 'active', created_at: iso(70) }),
    sales({ id: 'p-05', emp_code: 'SALES002', full_name: 'Ritu Sharma', status: 'active', sales_role: 'sales', hq_name: 'Khanna', asm_name: 'Sunita Kaur', rsm_name: 'Deepak Verma', employment_type: 'full_time', date_of_join: '2025-02-11', personal_email: 'ritu.s@gmail.com', phone: '99530 88112', monthly_gross: 25000, created_at: iso(60) }),
    sales({ id: 'p-06', emp_code: 'SALES003', full_name: 'Gurpreet Gill', status: 'active', sales_role: 'sales', hq_name: 'Jalandhar', asm_name: 'Manpreet Singh', rsm_name: 'Deepak Verma', employment_type: 'full_time', date_of_join: '2025-07-01', phone: '98761 44990', monthly_gross: 22000, created_at: iso(50) }),
    sales({ id: 'p-07', emp_code: 'SALES004', full_name: 'Karan Mehra', status: 'active', sales_role: 'sales', hq_name: 'Amritsar', asm_name: 'Manpreet Singh', rsm_name: 'Deepak Verma', employment_type: 'full_time', date_of_join: '2025-08-18', personal_email: 'karan.mehra@gmail.com', phone: '99100 22334', monthly_gross: 24000, created_at: iso(45) }),
    sales({ id: 'p-08', emp_code: 'SALES005', full_name: 'Meena Devi', status: 'active', sales_role: 'sales', hq_name: 'Patiala', asm_name: 'Sunita Kaur', rsm_name: 'Deepak Verma', employment_type: 'contract', date_of_join: '2025-11-03', phone: '97800 12034', monthly_gross: 20000, created_at: iso(42) }),
    sales({ id: 'p-09', emp_code: 'SALES006', full_name: 'Vikram Rathi', status: 'active', sales_role: 'sales', hq_name: 'Bathinda', asm_name: 'Sunita Kaur', rsm_name: 'Deepak Verma', employment_type: 'full_time', date_of_join: dateStr(-6), personal_email: 'vikram.rathi@gmail.com', phone: '98995 66778', monthly_gross: 24000, created_at: iso(12) }),
    sales({ id: 'p-10', emp_code: null, full_name: 'Neha Malhotra', status: 'joining', sales_role: 'sales', hq_name: 'Ludhiana', asm_name: 'Sunita Kaur', rsm_name: 'Deepak Verma', personal_email: 'neha.malhotra11@gmail.com', phone: '98111 90233', monthly_gross: 23000, notes: 'Offer accepted, joining 1st Oct.', created_at: iso(9) }),
    sales({ id: 'p-11', emp_code: null, full_name: 'Tarun Sethi', status: 'joining', sales_role: 'sales', hq_name: 'Jalandhar', asm_name: 'Manpreet Singh', rsm_name: 'Deepak Verma', personal_email: 'tarun.sethi@outlook.com', phone: '99887 66554', monthly_gross: 25000, notes: 'Final round cleared, docs pending.', created_at: iso(4) }),
  ...
  const form_links = [
    { id: 'fl-01', form_id: 'ft-referral', token: 'demo-source-ramesh', source_name: 'Consultant Ramesh — TalentBridge', active: true, expires_at: null, submission_count: 2, created_by: 'u-priya', created_at: iso(18) },
    { id: 'fl-02', form_id: 'ft-referral', token: 'demo-team-referrals', source_name: 'Employee referral', active: true, expires_at: null, submission_count: 2, created_by: 'u-priya', created_at: iso(28) },
  ]
  ...
  const candidates = [
    { id: 'c-01', full_name: 'Ankit Malhotra', designation: 'Sales Officer', area: 'Ludhiana', current_company: 'Patanjali Foods', phone: '98123 44556', email: null, referred_by_name: 'Ramesh Kumar (TalentBridge)', referrer_emp_id: null, source: 'Consultant Ramesh — TalentBridge', link_id: 'fl-01', response_id: 'fr-01', hr_comment: 'Strong FMCG channel experience. Call scheduled Friday.', picked_at: iso(3), prospective_id: 'pr-01', status: 'new', extra: {}, created_by: 'u-priya', created_at: iso(16), updated_at: iso(3) },
    { id: 'c-02', full_name: 'Shreya Iyer', designation: 'Territory Manager', area: 'Chandigarh', current_company: 'Himalaya Wellness', phone: '99880 11223', email: null, referred_by_name: 'Ramesh Kumar (TalentBridge)', referrer_emp_id: null, source: 'Consultant Ramesh — TalentBridge', link_id: 'fl-01', response_id: 'fr-01', hr_comment: null, picked_at: null, prospective_id: null, status: 'new', extra: {}, created_by: 'u-priya', created_at: iso(16), updated_at: iso(16) },
    { id: 'c-03', full_name: 'Harjinder Pal', designation: 'Senior Sales Executive', area: 'Mohali', current_company: 'Chandigarh Botanicals', phone: '98761 20034', email: null, referred_by_name: 'Deepak Verma', referrer_emp_id: 'RM001', source: 'Employee referral', link_id: 'fl-02', response_id: 'fr-02', hr_comment: 'Knows the ayurvedic distributor network well.', picked_at: iso(2), prospective_id: 'pr-02', status: 'new', extra: {}, created_by: 'u-priya', created_at: iso(25), updated_at: iso(2) },
    { id: 'c-04', full_name: 'Nikita Rao', designation: 'Sales Trainee', area: 'Patiala', current_company: 'Fresher (MBA)', phone: '90080 33445', email: null, referred_by_name: 'Campus cell — GNDU', referrer_emp_id: null, source: 'Campus cell — GNDU Amritsar', link_id: null, response_id: null, hr_comment: null, picked_at: null, prospective_id: null, status: 'new', extra: {}, created_by: 'u-priya', created_at: iso(2), updated_at: iso(2) },
    { id: 'c-05', full_name: 'Mohit Saini', designation: 'Field Sales Executive', area: 'Ludhiana', current_company: 'Local distributor', phone: '97110 88996', email: null, referred_by_name: 'Deepak Verma', referrer_emp_id: 'RM001', source: 'Employee referral', link_id: 'fl-02', response_id: 'fr-02', hr_comment: 'Available immediately', picked_at: null, prospective_id: null, status: 'new', extra: {}, created_by: 'u-priya', created_at: iso(25), updated_at: iso(6) },
    { id: 'c-06', full_name: 'Divya Kapoor', designation: 'Area Sales Manager', area: 'Amritsar', current_company: 'OmniActive Health', phone: '98220 55667', email: null, referred_by_name: 'LinkedIn outreach', referrer_emp_id: null, source: 'LinkedIn outreach', link_id: null, response_id: null, hr_comment: 'Too senior for current openings — keep warm.', picked_at: null, prospective_id: null, status: 'new', extra: {}, created_by: 'u-priya', created_at: iso(40), updated_at: iso(20) },
    { id: 'c-07', full_name: 'Rakesh Yadav', designation: 'Sales Executive', area: 'Jalandhar', current_company: 'AmbeAgro', phone: '96500 77881', email: null, referred_by_name: 'Manpreet Singh', referrer_emp_id: 'ASM002', source: 'Employee referral', link_id: 'fl-02', response_id: null, hr_comment: 'Salary expectation above band.', picked_at: null, prospective_id: null, status: 'new', extra: {}, created_by: 'u-priya', created_at: iso(30), updated_at: iso(22) },
    { id: 'c-08', full_name: 'Pooja Bhatt', designation: 'Sales Coordinator', area: 'Khanna', current_company: 'NutraLab India', phone: '98991 22110', email: null, referred_by_name: 'Ramesh Kumar (TalentBridge)', referrer_emp_id: null, source: 'Consultant Ramesh — TalentBridge', link_id: 'fl-01', response_id: null, hr_comment: 'Revisit when Khanna HQ opens.', picked_at: null, prospective_id: null, status: 'new', extra: {}, created_by: 'u-priya', created_at: iso(35), updated_at: iso(20) },
  ]
