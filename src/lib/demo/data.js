...
export function buildSeedStore() {
  ...
  const prospectives = [
    { id: 'pr-01', full_name: 'Ankit Malhotra', designation: 'Sales Officer', area: 'Ludhiana', contact: '+919812344556', source: 'Internal Referral', resume_path: 'pr-01/seed_ankit_malhotra_cv.pdf', resume_name: 'Ankit_Malhotra_CV.pdf', department: 'Sales', status: 'interview_scheduled', candidate_id: 'c-01', created_by: 'u-priya', created_at: iso(3), updated_at: iso(1) },
    { id: 'pr-02', full_name: 'Harjinder Pal', designation: 'Senior Sales Executive', area: 'Mohali', contact: '+919876120034', source: 'Internal Referral', department: 'Sales', status: 'offer_letter_sent', candidate_id: 'c-03', created_by: 'u-priya', created_at: iso(2), updated_at: iso(1) },
    { id: 'pr-03', full_name: 'Sandeep Walia', designation: 'Sales Rep', area: 'Bathinda', contact: '+919855210394', source: 'LI / Indeed', department: 'Sales', status: 'contacted', candidate_id: null, created_by: 'u-priya', created_at: iso(8), updated_at: iso(5) },
    { id: 'pr-04', full_name: 'Jaspreet Brar', designation: 'Sales Rep', area: 'Moga', contact: '+919780644121', source: 'LI / Indeed', department: 'PMT', status: 'new', candidate_id: null, created_by: 'u-priya', created_at: iso(1), updated_at: iso(1) },
    { id: 'pr-05', full_name: 'Ramanpreet Kaur', designation: 'Territory Manager', area: 'Amritsar', contact: 'raman.k@gmail.com', source: 'Other', department: 'Marketing', status: 'interested', candidate_id: null, created_by: 'u-priya', created_at: iso(12), updated_at: iso(6) },
    { id: 'pr-06', full_name: 'Vikram Rathi', designation: 'Sales Rep', area: 'Bathinda', contact: '+919899566778', source: 'LI / Indeed', department: 'Sales', status: 'joined', candidate_id: null, created_by: 'u-priya', created_at: iso(30), updated_at: iso(11) },
    { id: 'pr-07', full_name: 'Sahil Chopra', designation: 'Sales Rep', area: 'Ludhiana', contact: '+919914587230', source: 'Other', department: 'Doctor', status: 'rejected', candidate_id: null, created_by: 'u-priya', created_at: iso(22), updated_at: iso(15) },
  ]
