...
export function buildSeedStore() {
  ...
  const prospectives = [
    ...
    { id: 'pr-06', full_name: 'Vikram Rathi', designation: 'Sales Rep', area: 'Bathinda', contact: '+919899566778', source: 'LI / Indeed', status: 'joined', candidate_id: null, created_by: 'u-priya', created_at: iso(30), updated_at: iso(11) },
    { id: 'pr-07', full_name: 'Sahil Chopra', designation: 'Sales Rep', area: 'Ludhiana', contact: '+919914587230', source: 'Other', status: 'rejected', candidate_id: null, created_by: 'u-priya', created_at: iso(22), updated_at: iso(15) },
  ]
